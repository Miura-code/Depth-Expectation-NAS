...
class SearchStageConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--curriculum_epochs', nargs="*", type=int, default=[0, 50], help='# of each curriculum epochs')
        parser.add_argument('--T', type=float, default=10, help='temperature of softmax with temperature')
        parser.add_argument('--l', type=float, default=0, help='ratio between soft target loss and hard target loss')
        parser.add_argument('--g', type=float, default=0, help='Constraint weights for number of cells')
        ...
        parser.add_argument('--depth_coef', type=float, default=0.0, help='coefficient of depth loss for architecture loss')
        parser.add_argument('--slide_window', type=int, default=3, help='sliding window size')
        parser.add_argument('--discrete', type=int, default=1, help='Use stage specified cell architecture at each stage')
        parser.add_argument('--reset', type=int, default=0, help='Reset network parameters when searching is finished.')
        parser.add_argument('--arch_criterion', type=str, default='expected', help='Constraint Criteria for Parameter Beta. [l1, length, alphal1]')
        ...
        parser.add_argument('--genotype', default="BASELINE_BEST", help='Cell genotype')
